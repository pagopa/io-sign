...
module "io_sign_support_func_itn_roles" {
  source          = "pagopa-dx/azure-role-assignments/azurerm"
  version         = "~> 1.2.0"
  principal_id    = module.io_sign_support_func_itn.system_identity_principal
  ...
  key_vault = [
    {
      ...
      description         = "Allow ${module.io_sign_support_func_itn.name} to read secrets from ${module.key_vault.name}"
