locals {
  io_sign_user_func_itn = {
    ...
    app_settings = {
      ...
      userUploadedBlobContainerName     = azurerm_storage_container.itn_uploaded_documents.name
      userValidatedBlobContainerName    = azurerm_storage_container.itn_validated_documents.name
      ...
      NamirialPassword                  = module.key_vault_secrets_itn.values["NamirialPassword"].value
      NamirialTestApiBasePath           = "https://pagopa-test.namirial.com"
      NamirialTestUsername              = "api"
      NamirialTestPassword              = module.key_vault_secrets_itn.values["NamirialTestPassword"].value
      ...
      LollipopApiKey                    = module.key_vault_secrets_itn.values["LollipopPrimaryApiKey"].value
