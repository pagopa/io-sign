module "function_sign_user" {
  ...
  subnet_cidr                              = var.sign_user_snet_cidr
...
module "itn_sign_user_func_roles" {
  source          = "pagopa-dx/azure-role-assignments/azurerm"
  version         = "~> 1.2.0"
  principal_id    = module.function_sign_user.function_app.function_app.principal_id
...
module "itn_sign_user_func_staging_roles" {
  source          = "pagopa-dx/azure-role-assignments/azurerm"
  version         = "~> 1.2.0"
  principal_id    = module.function_sign_user.function_app.function_app.slot.principal_id
  subscription_id = data.azurerm_subscription.current.subscription_id
