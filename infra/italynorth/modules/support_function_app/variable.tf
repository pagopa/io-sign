...
variable "sign_support_snet_cidr" {
  type        = string
  description = "Services Subnet CIDR"
}

variable "function_support_autoscale_minimum" {
  type        = number
  description = "The minimum number of instances for this resource."
  default     = 1
}

variable "function_support_autoscale_maximum" {
  type        = number
  description = "The maximum number of instances for this resource."
  default     = 5
}

variable "function_support_autoscale_default" {
  type        = number
