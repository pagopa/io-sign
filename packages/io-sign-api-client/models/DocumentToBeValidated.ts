...
export class DocumentToBeValidated {
    /**
    * Entity Id
    */
    'id': string;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "DocumentToBeValidatedStatusEnum",
            "format": ""
        },
        {
            "name": "uploadedAt",
    ...
    static getAttributeTypeMap() {
        return DocumentToBeValidated.attributeTypeMap;
    }
...
export type DocumentToBeValidatedStatusEnum = "WAIT_FOR_VALIDATION" ;
