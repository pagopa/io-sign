...
export function CreateSignatureRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateSignatureRequestBody {
    ...
    return {
        ...
        'documentsMetadata': !exists(json, 'documents_metadata') ? undefined : ((json['documents_metadata'] as Array<any>).map(DocumentMetadataFromJSON)),
    };
}
...
export function CreateSignatureRequestBodyToJSON(value?: CreateSignatureRequestBody | null): any {
    ...
    return {
        ...
        'documents_metadata': value.documentsMetadata === undefined ? undefined : ((value.documentsMetadata as Array<any>).map(DocumentMetadataToJSON)),
    };
}
