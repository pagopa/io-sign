...
export function instanceOfDocumentMetadata(value: object): boolean {
    ...
    isInstance = isInstance && "signatureFields" in value;
...
export function DocumentMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentMetadata {
    ...
    return {
        ...
        'title': json['title'],
        'signatureFields': ((json['signature_fields'] as Array<any>).map(SignatureFieldFromJSON)),
    };
}
...
export function DocumentMetadataToJSON(value?: DocumentMetadata | null): any {
    ...
    return {
        ...
        'title': value.title,
        'signature_fields': ((value.signatureFields as Array<any>).map(SignatureFieldToJSON)),
    };
}
