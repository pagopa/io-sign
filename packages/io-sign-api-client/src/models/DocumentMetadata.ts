...
export function DocumentMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentMetadata {
    ...
    return {
        ...
        'title': json['title'],
        'signatureFields': !exists(json, 'signature_fields') ? undefined : ((json['signature_fields'] as Array<any>).map(SignatureFieldFromJSON)),
    };
}
...
export function DocumentMetadataToJSON(value?: DocumentMetadata | null): any {
    ...
    return {
        ...
        'title': value.title,
        'signature_fields': value.signatureFields === undefined ? undefined : ((value.signatureFields as Array<any>).map(SignatureFieldToJSON)),
    };
}
