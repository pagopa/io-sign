...
import { SignatureRequestApiRequestFactory } from "./../generated/apis/SignatureRequestApi";
import { CreateSignatureRequestBody } from '../generated/models/CreateSignatureRequestBody';
import { signatureRequestIdQuestion,
dossierIdQuestion,
signerIdQuestion,
expiresAtQuestion,
...
dossierIdQuestion
  ...
  apiInstance
    .getDocumentUploadUrl(answerGetDocumentUploadUrl.req_id, answerGetDocumentUploadUrl.doc_id)
    .then((data: RequestContext) => {
	createResponse(data)
    .then((data: EndpointResponse) => {
		console.log(data);
  ...
  apiInstance
    .setSignatureRequestStatus(answerSetSignatureRequestStatus.req_id, "READY")
    .then((data: RequestContext) => {
	createResponse(data)
    .then((data: EndpointResponse) => {
		console.log(data);
